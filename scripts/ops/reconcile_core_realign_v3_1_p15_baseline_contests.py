#!/usr/bin/env python3
"""Reconcilia STRUCT_LEI15_CORE_V3_1_P15_PROTECTED_15D_001 contra baseline 3705-3711."""
...
def _load_ge_and_games(conn) -> list[dict]:
    ...
    if not ge_rows:
        raise RuntimeError(f"Nenhum GE para {BATCH_LABEL}. Rode run_core_realign_v3_1_p15_test_15d.py primeiro.")
