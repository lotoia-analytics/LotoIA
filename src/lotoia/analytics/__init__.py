...
_EXPORTS: dict[str, tuple[str, str]] = {
    ...
    "OfficialContestRecord": ("lotoia.analytics.lotofacil_scientific_core", "OfficialContestRecord"),
    "ContestTransitionAnalysis": ("lotoia.analytics.lotofacil_scientific_core", "ContestTransitionAnalysis"),
    "ScientificHistoryProfile": ("lotoia.analytics.lotofacil_scientific_core", "ScientificHistoryProfile"),
    "ScientificGenerationPolicy": ("lotoia.analytics.lotofacil_scientific_core", "ScientificGenerationPolicy"),
    "LotofacilScientificCore": ("lotoia.analytics.lotofacil_scientific_core", "LotofacilScientificCore"),
    "ScientificCalibrationContext": ("lotoia.analytics.scientific_calibration_engine", "ScientificCalibrationContext"),
    "ScientificCalibrationDecisionPayload": ("lotoia.analytics.scientific_calibration_engine", "ScientificCalibrationDecisionPayload"),
    "load_official_lotofacil_contests": ("lotoia.analytics.lotofacil_scientific_core", "load_official_lotofacil_contests"),
    "analyze_lotofacil_history": ("lotoia.analytics.lotofacil_scientific_core", "analyze_lotofacil_history"),
    "analyze_contest_transition": ("lotoia.analytics.lotofacil_scientific_core", "analyze_contest_transition"),
    "build_scientific_profile": ("lotoia.analytics.lotofacil_scientific_core", "build_scientific_profile"),
    "discover_scientific_generation_policy": ("lotoia.analytics.lotofacil_scientific_core", "discover_scientific_generation_policy"),
    "get_scientific_generation_policy": ("lotoia.analytics.lotofacil_scientific_core", "get_scientific_generation_policy"),
    "build_calibration_context": ("lotoia.analytics.scientific_calibration_engine", "build_calibration_context"),
    "evaluate_last_batch": ("lotoia.analytics.scientific_calibration_engine", "evaluate_last_batch"),
    "generate_recalibration_policy": ("lotoia.analytics.scientific_calibration_engine", "generate_recalibration_policy"),
    "recommend_next_strategy": ("lotoia.analytics.scientific_calibration_engine", "recommend_next_strategy"),
    "apply_supervised_calibration": ("lotoia.analytics.scientific_calibration_engine", "apply_supervised_calibration"),
    "register_calibration_decision": ("lotoia.analytics.scientific_calibration_engine", "register_calibration_decision"),
