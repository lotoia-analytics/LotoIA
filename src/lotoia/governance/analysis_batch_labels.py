...
LEI15_CORE_REALIGNMENT_V3_1_PROTECTED_TEST = "LEI15_CORE_REALIGNMENT_V3_1_PROTECTED_TEST"
LEI15_CORE_REALIGNMENT_V3_1_P15_PROTECTED_TEST = "LEI15_CORE_REALIGNMENT_V3_1_P15_PROTECTED_TEST"
LEI15_CORE_REALIGNMENT_V4_PATTERN_PROTECTED_TEST = "LEI15_CORE_REALIGNMENT_V4_PATTERN_PROTECTED_TEST"
LEI15_CORE_CANDIDATE_001_TEST = "LEI15_CORE_CANDIDATE_001_TEST"
LEI15_CORE_002_SOVEREIGN = "LEI15_CORE_002_SOVEREIGN"
...
BATCH_TYPE_VALUES: tuple[str, ...] = (
    ...
    LEI15_CORE_REALIGNMENT_V3_1_P15_PROTECTED_TEST,
    LEI15_CORE_REALIGNMENT_V4_PATTERN_PROTECTED_TEST,
    LEI15_CORE_CANDIDATE_001_TEST,
...
# Labels LEI15 CORE V3.1 PROTECTED — shadow_test only
_LEI15_CORE_V3_1_PROTECTED_LABELS: tuple[str, ...] = (
    "STRUCT_LEI15_CORE_V3_1_PROTECTED_15D_001",
)

_LEI15_CORE_V3_1_P15_PROTECTED_LABELS: tuple[str, ...] = (
    "STRUCT_LEI15_CORE_V3_1_P15_PROTECTED_15D_001",
)

_LEI15_CORE_V4_PATTERN_PROTECTED_LABELS: tuple[str, ...] = (
    "STRUCT_LEI15_CORE_V4_PATTERN_PROTECTED_15D_001",
)

_LEI15_CORE_CANDIDATE_001_LABELS: tuple[str, ...] = (
    "STRUCT_LEI15_CORE_CANDIDATE_001_15D_001",
    "STRUCT_LEI15_CORE_CANDIDATE_001_B_15D_001",
    "STRUCT_LEI15_CORE_CANDIDATE_001_C_15D_001",
...
ALLOWED_BATCH_LABELS: tuple[str, ...] = (
    ...
    *_LEI15_CORE_V3_1_PROTECTED_LABELS,
    *_LEI15_CORE_V3_1_P15_PROTECTED_LABELS,
    *_LEI15_CORE_V4_PATTERN_PROTECTED_LABELS,
    *_LEI15_CORE_CANDIDATE_001_LABELS,
    *_LEI15_CORE_002_SOVEREIGN_LABELS,
)
...
_LEI15_CORE_V3_1_PATTERN = re.compile(r"^STRUCT_LEI15_CORE_V3_1_PROTECTED_(\d+)D_\d+$")
_LEI15_CORE_V3_1_P15_PATTERN = re.compile(r"^STRUCT_LEI15_CORE_V3_1_P15_PROTECTED_(\d+)D_\d+$")
_LEI15_CORE_V4_PATTERN = re.compile(r"^STRUCT_LEI15_CORE_V4_PATTERN_PROTECTED_(\d+)D_\d+$")
...
def batch_label_game_size(label: str | None) -> int | None:
    ...
    if m:
        return int(m.group(1))
    m = _LEI15_CORE_V3_1_P15_PATTERN.match(normalized)
    if m:
        return int(m.group(1))
    m = _LEI15_CORE_V4_PATTERN.match(normalized)
    if m:
        return int(m.group(1))
    m = _LEI15_CORE_CANDIDATE_001_PATTERN.match(normalized)
    if m:
        return 15
...
def infer_batch_type(label: str | None) -> str:
    normalized = str(label or "").strip().upper()
    if normalized.startswith("STRUCT_LEI15_CORE_CANDIDATE_002_"):
        return LEI15_CORE_002_SOVEREIGN
    if normalized.startswith("STRUCT_LEI15_CORE_CANDIDATE_001_"):
        return LEI15_CORE_CANDIDATE_001_TEST
    if normalized.startswith("STRUCT_LEI15_CORE_V4_PATTERN_PROTECTED_"):
        return LEI15_CORE_REALIGNMENT_V4_PATTERN_PROTECTED_TEST
    if normalized.startswith("STRUCT_LEI15_CORE_V3_1_P15_PROTECTED_"):
        return LEI15_CORE_REALIGNMENT_V3_1_P15_PROTECTED_TEST
    if normalized.startswith("STRUCT_LEI15_CORE_V3_1_PROTECTED_"):
        return LEI15_CORE_REALIGNMENT_V3_1_PROTECTED_TEST
