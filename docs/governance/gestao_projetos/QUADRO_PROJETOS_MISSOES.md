...
| M-DADOS-039 | Área Restrita / Limpeza Controlada protegida pela Lei 001 | `agent_dados` + `agent_governanca` | `CONCLUIDA` | branch `cursor/m-dados-039-limpeza-controlada-cae6` — build `institutional-adm-runtime-v15` |
