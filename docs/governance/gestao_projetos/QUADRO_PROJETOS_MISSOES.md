...
| Atualização | 2026-06-18 (M-PLAT-050 pool PostgreSQL Streamlit) |
...
|-----------|--------|-----------------|--------|----------------------|
| M-PLAT-050 | Corrigir saturação pool PostgreSQL Streamlit | `agent_plataforma` + `agent_dados` | `CONCLUIDA` | [PR TBD] — build `institutional-adm-runtime-v26` |
