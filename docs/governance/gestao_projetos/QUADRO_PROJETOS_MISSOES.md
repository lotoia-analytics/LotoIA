...
| Atualização | 2026-06-17 (M-VIS-036 Simulação Institucional / Backtesting) |
...
| M-VIS-036 | Simulação Institucional / Backtesting | `agent_estatistico` + `agent_ml` | `EM EXECUCAO / AGUARDANDO REVIEW` | branch `cursor/m-vis-036-simulacao-backtesting-cae6` |
